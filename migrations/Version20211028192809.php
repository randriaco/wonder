 ...
 */
final class Version20211028192809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE rating rating SMALLINT NOT NULL, CHANGE nbr_of_response nbr_of_response SMALLINT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE rating rating INT NOT NULL, CHANGE nbr_of_response nbr_of_response INT NOT NULL');
    }
}
